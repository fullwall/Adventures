	...
	*/
	...
	public final void mML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:223:12: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:224:5: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:224:10: ( options {greedy=false; } : . )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:224:38: .
					{
					matchAny(); 
					}
					break;
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:226:14: ( '//' (~ NEWLINE )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:227:5: '//' (~ NEWLINE )*
			{
			match("//"); 

			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:227:10: (~ NEWLINE )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:229:4: ( ( ' ' | '\\t' | '\\n' | '\\r' )+ )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:230:5: ( ' ' | '\\t' | '\\n' | '\\r' )+
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:230:5: ( ' ' | '\\t' | '\\n' | '\\r' )+
			int cnt3=0;
			loop3:
	...
	public final void mQUERY_KEY() throws RecognitionException {
		try {
			int _type = QUERY_KEY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:232:11: ( '$' IDENT ( '.' ( IDENT | QUERY_KEY_VAR ) )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:5: '$' IDENT ( '.' ( IDENT | QUERY_KEY_VAR ) )*
			{
			match('$'); 
			mIDENT(); 

			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:15: ( '.' ( IDENT | QUERY_KEY_VAR ) )*
			loop5:
			while (true) {
				int alt5=2;
				...
				switch (alt5) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:16: '.' ( IDENT | QUERY_KEY_VAR )
					{
					match('.'); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:20: ( IDENT | QUERY_KEY_VAR )
					int alt4=2;
					...
					switch (alt4) {
						case 1 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:21: IDENT
							{
							mIDENT(); 
							...
							break;
						case 2 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:233:29: QUERY_KEY_VAR
							{
							mQUERY_KEY_VAR(); 
	...
	public final void mIDENT() throws RecognitionException {
		try {
			int _type = IDENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:235:7: ( LETTER ( LETTER | '_' | DIGIT )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:236:5: LETTER ( LETTER | '_' | DIGIT )*
			{
			mLETTER(); 

			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:236:12: ( LETTER | '_' | DIGIT )*
			loop6:
			while (true) {
				int alt6=2;
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:238:8: ( ( '-' )? ( DIGIT )+ ( '.' ( DIGIT )+ )? )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:5: ( '-' )? ( DIGIT )+ ( '.' ( DIGIT )+ )?
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:5: ( '-' )?
			int alt7=2;
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:10: ( DIGIT )+
			int cnt8=0;
			loop8:
			while (true) {
				int alt8=2;
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:17: ( '.' ( DIGIT )+ )?
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:18: '.' ( DIGIT )+
					{
					match('.'); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:239:22: ( DIGIT )+
					int cnt9=0;
					loop9:
					while (true) {
						int alt9=2;
	...
	public final void mSTRING_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:241:16: ( '\"' ( . )* '\"' | '\\'' ( . )* '\\'' )
			int alt13=2;
			...
			switch (alt13) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:242:5: '\"' ( . )* '\"'
					{
					match('\"'); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:242:9: ( . )*
					loop11:
					while (true) {
						int alt11=2;
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:243:7: '\\'' ( . )* '\\''
					{
					match('\''); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:243:12: ( . )*
					loop12:
					while (true) {
						int alt12=2;
	...
	public final void mNEWLINE() throws RecognitionException {
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:246:18: ( '\\n' | '\\r' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:
			{
			if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
				input.consume();
	...
	public final void mQUERY_KEY_VAR() throws RecognitionException {
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:249:24: ( '${' IDENT ( '.' IDENT )* '}' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:250:5: '${' IDENT ( '.' IDENT )* '}'
			{
			match("${"); 

			mIDENT(); 

			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:250:16: ( '.' IDENT )*
			loop14:
			while (true) {
				int alt14=2;
				...
				switch (alt14) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:250:17: '.' IDENT
					{
					match('.'); 
					mIDENT(); 
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:252:17: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:
			{
	...
	public final void mDIGIT() throws RecognitionException {
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:255:16: ( ( '0' .. '9' ) )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:
			{
			if ( (input.LA(1) >= '0' && input.LA(1) <= '9') ) {
				input.consume();
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:258:18: ( ( DIGIT )+ )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:259:5: ( DIGIT )+
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:259:5: ( DIGIT )+
			int cnt15=0;
			loop15:
