// $ANTLR 3.5 net\\citizensnpcs\\adventures\\dialog\\Dialog.g 2013-02-23 15:14:11
...
public class DialogParser extends Parser {
	...
	*/
	...
	// $ANTLR start "program"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:53:1: program[DialogEngine.ParseContext context] : ( rule[context] | response[context] )* ;
	public final void program(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:53:45: ( ( rule[context] | response[context] )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:54:5: ( rule[context] | response[context] )*
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:54:5: ( rule[context] | response[context] )*
			loop1:
			while (true) {
				...
				switch (alt1) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:55:9: rule[context]
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:56:11: response[context]
					{
	...
	// $ANTLR start "name"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:59:1: name[DialogEngine.ParseContext context] returns [String name] : (i1= IDENT |i2= IDENT '/' i3= IDENT ) ;
	public final String name(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:59:64: ( (i1= IDENT |i2= IDENT '/' i3= IDENT ) )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:60:5: (i1= IDENT |i2= IDENT '/' i3= IDENT )
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:60:5: (i1= IDENT |i2= IDENT '/' i3= IDENT )
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:61:9: i1= IDENT
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:62:11: i2= IDENT '/' i3= IDENT
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:66:1: response[DialogEngine.ParseContext context] returns [Response response] : 'response' name[context] '{' ( response_statement[context, builder] ';' )* '}' ;
	public final Response response(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:66:74: ( 'response' name[context] '{' ( response_statement[context, builder] ';' )* '}' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:67:5: 'response' name[context] '{' ( response_statement[context, builder] ';' )* '}'
			{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:68:64: ( response_statement[context, builder] ';' )*
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:68:65: response_statement[context, builder] ';'
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:72:1: response_statement[DialogEngine.ParseContext context, Response.Builder builder] : ( remember_statement | generic_statement[context] );
	public final void response_statement(DialogEngine.ParseContext context, Response.Builder builder) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:72:82: ( remember_statement | generic_statement[context] )
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:73:5: remember_statement
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:74:7: generic_statement[context]
					{
	...
	// $ANTLR start "rule"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:77:1: rule[DialogEngine.ParseContext context] returns [Collection<String> eventNames, Rule rule] : 'rule' name[context] '{' criteria[builder] ';' ( rule_statement[context, builder] ';' )* '}' ;
	public final DialogParser.rule_return rule(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:77:92: ( 'rule' name[context] '{' criteria[builder] ';' ( rule_statement[context, builder] ';' )* '}' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:78:5: 'rule' name[context] '{' criteria[builder] ';' ( rule_statement[context, builder] ';' )* '}'
			{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:81:13: ( rule_statement[context, builder] ';' )*
			loop5:
			while (true) {
				int alt5=2;
				...
				switch (alt5) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:81:14: rule_statement[context, builder] ';'
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:86:1: rule_statement[DialogEngine.ParseContext context, Rule.Builder builder] : ( ( 'response' n= name[context] ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )? ) | remember_statement | generic_statement[context] );
	public final void rule_statement(DialogEngine.ParseContext context, Rule.Builder builder) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:86:74: ( ( 'response' n= name[context] ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )? ) | remember_statement | generic_statement[context] )
			int alt8=3;
			switch ( input.LA(1) ) {
			case 47:
				{
			...
			switch (alt8) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:87:5: ( 'response' n= name[context] ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )? )
					{
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:87:5: ( 'response' n= name[context] ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )? )
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:87:6: 'response' n= name[context] ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )?
					{
					...
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:88:9: ( 'then' (target= IDENT |target= NUMBER ) event= IDENT )?
					int alt7=2;
					...
					switch (alt7) {
						case 1 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:90:13: 'then' (target= IDENT |target= NUMBER ) event= IDENT
							{
							match(input,50,FOLLOW_50_in_rule_statement409); 
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:90:20: (target= IDENT |target= NUMBER )
							int alt6=2;
							...
							switch (alt6) {
								case 1 :
									// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:90:21: target= IDENT
									{
									target=(Token)match(input,IDENT,FOLLOW_IDENT_in_rule_statement414); 
									}
									break;
								case 2 :
									// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:90:36: target= NUMBER
									{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:94:7: remember_statement
					{
					...
					break;
				case 3 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:95:7: generic_statement[context]
					{
	...
	// $ANTLR start "block"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:98:1: block[DialogEngine.ParseContext context] returns [QueryRunnable statement] : 'random {' ( generic_statement[context] ':' NUMBER )+ '}' ;
	public final QueryRunnable block(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:98:77: ( 'random {' ( generic_statement[context] ':' NUMBER )+ '}' )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:99:5: 'random {' ( generic_statement[context] ':' NUMBER )+ '}'
			{
			match(input,45,FOLLOW_45_in_block500); 
			 SequentialRandomSelector.Builder builder = SequentialRandomSelector.builder(); 
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:101:9: ( generic_statement[context] ':' NUMBER )+
			int cnt9=0;
			loop9:
			while (true) {
				int alt9=2;
				...
				switch (alt9) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:102:13: generic_statement[context] ':' NUMBER
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:107:1: generic_statement[DialogEngine.ParseContext context] returns [QueryRunnable statement] : ( block[context] |i1= IDENT (a1= argument_decl ( ',' a2= argument_decl )* )? {...}?);
	public final QueryRunnable generic_statement(DialogEngine.ParseContext context) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:107:89: ( block[context] |i1= IDENT (a1= argument_decl ( ',' a2= argument_decl )* )? {...}?)
			int alt12=2;
			...
			switch (alt12) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:108:5: block[context]
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:109:7: i1= IDENT (a1= argument_decl ( ',' a2= argument_decl )* )? {...}?
					{
					...
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:111:5: (a1= argument_decl ( ',' a2= argument_decl )* )?
					int alt11=2;
					...
					switch (alt11) {
						case 1 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:112:9: a1= argument_decl ( ',' a2= argument_decl )*
							{
							...
							state._fsp--;
							 ...
							 vars.add(a1); 
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:113:9: ( ',' a2= argument_decl )*
							loop10:
							while (true) {
								int alt10=2;
								...
								switch (alt10) {
								case 1 :
									// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:114:13: ',' a2= argument_decl
									{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:119:1: argument_decl returns [Argument arg] : (i1= IDENT ':' e1= expression |e2= expression );
	public final Argument argument_decl() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:119:38: (i1= IDENT ':' e1= expression |e2= expression )
			int alt13=2;
			...
			switch (alt13) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:120:5: i1= IDENT ':' e1= expression
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:121:7: e2= expression
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:123:1: remember_statement returns [QueryRunnable statement] : 'remember' remember_assignment[builder] ( ',' remember_assignment[builder] )* ;
	public final QueryRunnable remember_statement() throws RecognitionException {
		QueryRunnable statement = null;


		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:123:54: ( 'remember' remember_assignment[builder] ( ',' remember_assignment[builder] )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:124:5: 'remember' remember_assignment[builder] ( ',' remember_assignment[builder] )*
			{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:125:45: ( ',' remember_assignment[builder] )*
			loop14:
			while (true) {
				int alt14=2;
				...
				switch (alt14) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:125:46: ',' remember_assignment[builder]
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:129:1: remember_assignment[Remember.Builder builder] :q= query ':' expression (i1= INTEGER i2= time_unit )? ( '-p' )? ;
	public final void remember_assignment(Remember.Builder builder) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:129:48: (q= query ':' expression (i1= INTEGER i2= time_unit )? ( '-p' )? )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:130:5: q= query ':' expression (i1= INTEGER i2= time_unit )? ( '-p' )?
			{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:132:9: (i1= INTEGER i2= time_unit )?
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:133:13: i1= INTEGER i2= time_unit
					{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:135:9: ( '-p' )?
			int alt16=2;
			...
			switch (alt16) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:136:13: '-p'
					{
	...
	public final Collection<String> criteria(Rule.Builder builder) throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:141:72: ( 'criteria' ( 'events=' e1= IDENT ( ',' e2= IDENT )* ) (i1= query '=' op1= expression r1= require |i2= query '>' op2= expression r2= require |i3= query '<' op3= expression r3= require |i4= query '<=' op4= expression r4= require |i5= query '>=' op5= expression r5= require |i6= query '!=' op6= expression r6= require |i7= query '~=' op7= '/' (regex=~ ( '/' ) )+ '/' r7= require |i8= query r8= require )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:142:5: 'criteria' ( 'events=' e1= IDENT ( ',' e2= IDENT )* ) (i1= query '=' op1= expression r1= require |i2= query '>' op2= expression r2= require |i3= query '<' op3= expression r3= require |i4= query '<=' op4= expression r4= require |i5= query '>=' op5= expression r5= require |i6= query '!=' op6= expression r6= require |i7= query '~=' op7= '/' (regex=~ ( '/' ) )+ '/' r7= require |i8= query r8= require )*
			{
			 eventNames = new ArrayList<String>(); 
			match(input,37,FOLLOW_37_in_criteria930); 
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:143:16: ( 'events=' e1= IDENT ( ',' e2= IDENT )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:144:21: 'events=' e1= IDENT ( ',' e2= IDENT )*
			{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:144:72: ( ',' e2= IDENT )*
			loop17:
			while (true) {
				int alt17=2;
				...
				switch (alt17) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:144:73: ',' e2= IDENT
					{
			...
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:146:5: (i1= query '=' op1= expression r1= require |i2= query '>' op2= expression r2= require |i3= query '<' op3= expression r3= require |i4= query '<=' op4= expression r4= require |i5= query '>=' op5= expression r5= require |i6= query '!=' op6= expression r6= require |i7= query '~=' op7= '/' (regex=~ ( '/' ) )+ '/' r7= require |i8= query r8= require )*
			loop19:
			while (true) {
				int alt19=9;
				...
				switch (alt19) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:147:9: i1= query '=' op1= expression r1= require
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:148:11: i2= query '>' op2= expression r2= require
					{
					...
					break;
				case 3 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:149:11: i3= query '<' op3= expression r3= require
					{
					...
					break;
				case 4 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:150:11: i4= query '<=' op4= expression r4= require
					{
					...
					break;
				case 5 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:151:11: i5= query '>=' op5= expression r5= require
					{
					...
					break;
				case 6 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:152:11: i6= query '!=' op6= expression r6= require
					{
					...
					break;
				case 7 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:153:11: i7= query '~=' op7= '/' (regex=~ ( '/' ) )+ '/' r7= require
					{
					...
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:153:38: (regex=~ ( '/' ) )+
					int cnt18=0;
					loop18:
					while (true) {
						int alt18=2;
					...
					break;
				case 8 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:154:11: i8= query r8= require
					{
					...
					state._fsp--;
					 ...
					 builder.criterion(NumberQueryPredicate.alwaysTrue(i8, r8)); 
					}
					break;
	...
	// $ANTLR start "require"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:157:1: require returns [boolean required] : ( '!' )? ;
	public final boolean require() throws RecognitionException {
		boolean required = false;


		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:157:36: ( ( '!' )? )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:158:5: ( '!' )?
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:158:5: ( '!' )?
			int alt20=2;
			...
			switch (alt20) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:158:7: '!'
					{
	...
	// $ANTLR start "query"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:159:1: query returns [Evaluator value] : q= QUERY_KEY ;
	public final Evaluator query() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:159:33: (q= QUERY_KEY )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:160:5: q= QUERY_KEY
			{
			q=(Token)match(input,QUERY_KEY,FOLLOW_QUERY_KEY_in_query1253); 
			 value = StringEvaluator.create((q!=null?q.getText():null)); 
			}
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:163:1: expression returns [Evaluator value] : op1= mult ( '+' op2= mult | '-' op2= mult )* ;
	public final Evaluator expression() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:163:38: (op1= mult ( '+' op2= mult | '-' op2= mult )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:164:5: op1= mult ( '+' op2= mult | '-' op2= mult )*
			{
			...
			state._fsp--;
			 ...
			 value = op1; 
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:165:5: ( '+' op2= mult | '-' op2= mult )*
			loop21:
			while (true) {
				int alt21=3;
				...
				switch (alt21) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:166:5: '+' op2= mult
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:167:8: '-' op2= mult
					{
	...
	// $ANTLR start "unary"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:170:1: unary returns [Evaluator value] : ( '+' | '-' )* term ;
	public final Evaluator unary() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:170:33: ( ( '+' | '-' )* term )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:171:5: ( '+' | '-' )* term
			{
			 boolean positive = true; 
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:172:5: ( '+' | '-' )*
			loop22:
			while (true) {
				int alt22=3;
				...
				switch (alt22) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:172:6: '+'
					{
					match(input,23,FOLLOW_23_in_unary1347); 
					}
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:172:12: '-'
					{
	...
	// $ANTLR start "mult"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:179:1: mult returns [Evaluator value] : op1= unary ( '*' op2= unary | '/' op2= unary | '%' op2= unary | '**' op2= unary )* ;
	public final Evaluator mult() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:179:32: (op1= unary ( '*' op2= unary | '/' op2= unary | '%' op2= unary | '**' op2= unary )* )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:180:5: op1= unary ( '*' op2= unary | '/' op2= unary | '%' op2= unary | '**' op2= unary )*
			{
			...
			state._fsp--;
			 ...
			 value = op1; 
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:181:5: ( '*' op2= unary | '/' op2= unary | '%' op2= unary | '**' op2= unary )*
			loop23:
			while (true) {
				int alt23=5;
				switch ( input.LA(1) ) {
				...
				switch (alt23) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:182:9: '*' op2= unary
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:183:11: '/' op2= unary
					{
					...
					break;
				case 3 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:184:11: '%' op2= unary
					{
					...
					break;
				case 4 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:185:11: '**' op2= unary
					{
	...
	// $ANTLR start "term"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:188:1: term returns [Evaluator value] : ( '(' expression ')' |b= bool | NUMBER | STRING_LITERAL |q= query | '[' (exp1= expression ( ',' exp2= expression )* )? ']' | '{' ( map_pair[vars] ( ',' map_pair[vars] )* )? '}' );
	public final Evaluator term() throws RecognitionException {
		...
		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:188:32: ( '(' expression ')' |b= bool | NUMBER | STRING_LITERAL |q= query | '[' (exp1= expression ( ',' exp2= expression )* )? ']' | '{' ( map_pair[vars] ( ',' map_pair[vars] )* )? '}' )
			int alt28=7;
			switch ( input.LA(1) ) {
			case 19:
				{
			...
			switch (alt28) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:189:5: '(' expression ')'
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:190:7: b= bool
					{
					...
					break;
				case 3 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:191:7: NUMBER
					{
					...
					break;
				case 4 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:192:7: STRING_LITERAL
					{
					STRING_LITERAL17=(Token)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_term1518); 
					 value = StringEvaluator.create((STRING_LITERAL17!=null?STRING_LITERAL17.getText():null)); 
					}
					break;
				case 5 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:193:7: q= query
					{
					pushFollow(FOLLOW_query_in_term1530);
					q=query();
					state._fsp--;

					 value = VariableEvaluator.create(q); 
					}
					break;
				case 6 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:194:7: '[' (exp1= expression ( ',' exp2= expression )* )? ']'
					{
					match(input,35,FOLLOW_35_in_term1541); 
					 List<Evaluator> array = Lists.newArrayList(); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:196:13: (exp1= expression ( ',' exp2= expression )* )?
					int alt25=2;
					...
					switch (alt25) {
						case 1 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:197:14: exp1= expression ( ',' exp2= expression )*
							{
							...
							state._fsp--;
							 ...
							 array.add(exp1); 
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:198:14: ( ',' exp2= expression )*
							loop24:
							while (true) {
								int alt24=2;
								...
								switch (alt24) {
								case 1 :
									// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:198:15: ',' exp2= expression
									{
					...
					break;
				case 7 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:201:7: '{' ( map_pair[vars] ( ',' map_pair[vars] )* )? '}'
					{
					match(input,53,FOLLOW_53_in_term1646); 
					 Map<String, Evaluator> vars = Maps.newHashMap(); 
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:203:11: ( map_pair[vars] ( ',' map_pair[vars] )* )?
					int alt27=2;
					...
					switch (alt27) {
						case 1 :
							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:203:12: map_pair[vars] ( ',' map_pair[vars] )*
							{
							pushFollow(FOLLOW_map_pair_in_term1672);
							map_pair(vars);
							state._fsp--;

							// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:203:27: ( ',' map_pair[vars] )*
							loop26:
							while (true) {
								int alt26=2;
								...
								switch (alt26) {
								case 1 :
									// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:203:28: ',' map_pair[vars]
									{
	...
	// $ANTLR start "bool"
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:207:1: bool returns [boolean value] : ( 'true' | 'false' ) ;
	public final boolean bool() throws RecognitionException {
		boolean value = false;


		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:207:30: ( ( 'true' | 'false' ) )
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:208:5: ( 'true' | 'false' )
			{
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:208:5: ( 'true' | 'false' )
			int alt29=2;
			...
			switch (alt29) {
				case 1 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:208:6: 'true'
					{
					...
					break;
				case 2 :
					// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:208:34: 'false'
					{
	...
	// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:213:1: time_unit returns [TimeUnit unit] : ( 'ns' | 'us' | 'ms' | 's' | 'm' | 'h' | 'd' );
	public final TimeUnit time_unit() throws RecognitionException {
		TimeUnit unit = null;


		try {
			// net\\citizensnpcs\\adventures\\dialog\\Dialog.g:213:35: ( 'ns' | 'us' | 'ms' | 's' | 'm' | 'h' | 'd' )
			int alt30=7;
			switch ( input.LA(1) ) {
			case 44:
				{
